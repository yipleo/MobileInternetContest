package com.fro.ble_temhumcase;

import java.util.Timer;
import java.util.TimerTask;
import java.util.UUID;

import com.fro.ble_temhumcase.BluetoothLeClass.OnDataAvailableListener;
import com.fro.ble_temhumcase.BluetoothLeClass.OnServiceDiscoverListener;
	...
	private BluetoothLeClass.OnDataAvailableListener mOnDataAvailable = new OnDataAvailableListener() {
		...
		public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
			...
			if (characteristic.getUuid().toString().equals(UUID_CHAR6)) {
				...
				Float fData1 = FROTemHum.getTemData(Const.TEMHUM_LEN, Const.NODE_NUM, readBuff);
				String value1 = String.valueOf((int) (float) fData1);

				Float fData2 = FROTemHum.getHumData(Const.TEMHUM_LEN, Const.NODE_NUM, readBuff);
				String value2 = String.valueOf((int) (float) fData2);
